...
public abstract class RegexTest extends Test {
	 ...
	 * @throws name.hon2a.asm.TestException if supplied regular expression is invalid
	 * @see name.hon2a.asme.RegexTest::matchFile()
	 */
	 ...
	 * @throws name.hon2a.asm.TestException if supplied regular expression is invalid
	 * @see name.hon2a.asme.RegexTest::match()
	 */
