...
require_once CheckerRunner::$root . '/files/plugins/DTD2014/Dtd2014Checker.php';
...
class DtdTest extends PHPUnit_Framework_TestCase {
    ...
    private function runDtdTestFull($zipFile, $fulfillment = null, $details = "")
    {
        ...
        $result = CheckerRunner::runChecker(new Dtd2014Checker(), Filesystem::combinePaths(CheckerRunner::$root, "phptests/plugins/cases/DTD",  $zipFile), [5, 10]);
        CheckerRunner::assert($this, $zipFile, $result, $fulfillment, $details);
    }
    private function runDtdTest($zipFile, $fulfillment = null, $details = "")
    {
        $result = CheckerRunner::runChecker(new Dtd2014Checker(), Filesystem::combinePaths(CheckerRunner::$root, "phptests/plugins/cases/DTD",  $zipFile), [0, 0]);
        CheckerRunner::assert($this, $zipFile, $result, $fulfillment, $details);
    }
