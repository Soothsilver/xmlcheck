...
require_once CheckerRunner::$root . '/files/plugins/XML XSLT/XsltChecker.php';
...
class XsltTest extends PHPUnit_Framework_TestCase {
    ...
    {
        $result = CheckerRunner::runChecker(new XsltChecker(), Filesystem::combinePaths(CheckerRunner::$root, "phptests/plugins/cases/XSLT",  $zipFile), [$templateCount]);
