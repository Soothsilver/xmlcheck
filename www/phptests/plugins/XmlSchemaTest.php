...
require_once CheckerRunner::$root . '/files/plugins/XML XMLSchema/XmlSchemaChecker.php';
...
class XmlSchemaTest extends PHPUnit_Framework_TestCase {
    ...
    {
        $result = CheckerRunner::runChecker(new XmlSchemaChecker(), Filesystem::combinePaths(CheckerRunner::$root, "phptests/plugins/cases/SCHEMA",  $zipFile), []);
