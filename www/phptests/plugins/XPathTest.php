...
require_once CheckerRunner::$root . '/files/plugins/XML XPath/XpathChecker.php';
...
class XPathTest extends PHPUnit_Framework_TestCase {
    ...
    {
        $result = CheckerRunner::runChecker(new XpathChecker(), Filesystem::combinePaths(CheckerRunner::$root, "phptests/plugins/cases/XPATH",  $zipFile), [5]);
